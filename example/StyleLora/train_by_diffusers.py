...
from dataset import StyleDataseet, build_train_dataloader
...
def main():
    ...
    train_dataloader = build_train_dataloader(
        root_dir='/mnt/data/aigc-dataset/aigc-style/collect-data',
        sample_list_file_path=
        '/mnt/data/aigc-dataset/aigc-style/collect-data/sample_list/sample_list-style--watercolor_painting--v0.0/train-sample_list.txt',
        tokenizer=tokenizer)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                latents = vae.encode(batch["batch_rgb_img"].to(
